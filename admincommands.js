(function(){
    ...
    console.log('Available admin commands: SetScrap(x), SetRebirth(x), setbrick(x), settokens(x), droptire(), settires(x), resetblueupgrade(), SendStorm(), resettree(), resetsave()');
})();
